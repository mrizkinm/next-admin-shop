...
export const columns: ColumnDef<Product>[] = [
  ...
  },
  {
    accessorKey: "images",
    header: "Image",
    cell: ({row}) => row.original.images && row.original.images.length > 0 ? (
      <img src={row.original.images[0].url} className="rounded-sm w-16 h-16 object-cover" alt="Image" title={row.original.name} />
    ) : null
  },
  {
